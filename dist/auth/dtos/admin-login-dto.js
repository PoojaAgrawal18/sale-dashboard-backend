...
let AdminLoginDto = (() => {
    ...
    return _a = class AdminLoginDto {
        ...
        (() => {
            ...
            _username_decorators = [(0, class_validator_1.IsEmail)(), (0, class_validator_1.IsNotEmpty)(), (0, class_transformer_1.Transform)(({ value }) => value?.toLowerCase()), (0, class_transformer_1.Expose)()];
            _password_decorators = [(0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)(), (0, class_transformer_1.Expose)()];
